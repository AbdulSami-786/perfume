    ...
    <div className="bg-white font-sans text-gray-900 overflow-x-hidden">
              ...
              return (
                <div key={product.id} className="min-w-[240px] md:min-w-[280px] snap-start group bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500">
                  <Link to={`/product/${product.id}`} className="relative overflow-hidden aspect-[4/5] block">
                    <span className="absolute top-3 left-3 bg-black text-white px-2 py-1 text-[8px] md:text-[10px] tracking-widest z-10 font-bold">SALE</span>
                    {quantity > 0 && (
                  ...
                  <div className="p-4 md:p-6 text-center">
                    ...
                    <div className="flex justify-center items-center gap-3 mb-4 md:mb-6">
                      ...
                      <span className="text-base md:text-lg font-bold text-black font-serif">
                        Rs.{product.price}
                      </span>
                    </div>
                    <button 
      ...
      <section className="space-y-4 mb-12 md:mb-20 px-4">
        {categories.map((cat, idx) => (
          <Link key={idx} to={cat.link} className="relative block h-64 md:h-[450px] w-full group overflow-hidden">
            <img 
              src={cat.image} 
              alt={cat.name} 
